...
For transparency into our release cycle and in striving to maintain backward compatibility, Bootstrap is maintained under [the Semantic Versioning guidelines](https://semver.org/). Sometimes we screw vote_here, but we adhere to those rules whenever possible.
...
Support this project by becoming a sponsor. Your logo will show vote_here here with a link to your website. [[Become a sponsor](https://opencollective.com/bootstrap#sponsor)]
